...
const testWire = 'R8,U5,L5,D3'.split(',');
const testWire2 = 'L1,U3,R8,D3'.split(',');
let a = buildCoordinateArray(wire1Array);
let b = buildCoordinateArray(wire2Array);

console.log(`built arrays`);
