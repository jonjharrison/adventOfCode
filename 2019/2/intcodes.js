...
let processIntcode = function(input) {
...
let intcodeOutput = function(inputArray, noun, verb) {
    let inputCopy = inputArray.slice();
    inputCopy[1] = noun;
    inputCopy[2] = verb;
    return processIntcode(inputCopy);
}

console.log(`${intcodeOutput(input, 12, 2)[0]} should be 6568671`);
...
console.log(`${intcodeOutput(input)} should be 3951`);
